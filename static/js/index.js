...
async function tomarImagen(){
    ...
    fileInput.onchange = async e=>{
        ...
        miniaturaImagen.style.maxWidth = '3rem';
        miniaturaImagen.style.maxHeight = '3rem';
        miniaturaImagena.style.margin = '0.5rem';

        document.querySelector('.entrada_container').insertBefore(miniaturaImagen, input);
...
async function enviarMensaje() {
    ...
    let estados = ['Analizando .', 'Analizando ..', 'Analizando ...'];
    let indiceEstado = 0;
